...
$sql = "SELECT progress.project_name, project.employee_name, progress.progress FROM progress INNER JOIN project ON progress.project_name = project.project_name;"  ;
